...
train_data = pd.read_csv('nmslTrainning.csv', lineterminator='\n') #读数据
test_data = pd.read_csv('nmslTest.csv', lineterminator='\n')
...
model.save("CNNw2vModel11")
model.wv.save_word2vec_format("CNNVector11",binary=False)
print(model)

w2v_model = word2vec.Word2Vec.load("CNNw2vModel11") #直接加载成品
...
model.save("TextCNN11")

#预测与评估
mainModel = load_model('TextCNN11')
